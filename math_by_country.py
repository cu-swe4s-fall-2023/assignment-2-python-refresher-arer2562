    ...
    with open(data_file, 'r') as file:
        ...
        for row in reader:
            ...
            try:
                ...
                raise ValueError(f"Skipping row with non-numeric values: {row}")
            finally:
...
def generate_histogram(data, out_dir, title, x_label, y_label):
    ...
    generate_single_histogram(quartile_1, out_dir, "quartile_1.png", title, x_label, y_label)
    generate_single_histogram(quartile_2, out_dir, "quartile_2.png", title, x_label, y_label)
    generate_single_histogram(quartile_3, out_dir, "quartile_3.png", title, x_label, y_label)
    generate_single_histogram(quartile_4, out_dir, "quartile_4.png", title, x_label, y_label)

def generate_single_histogram(data, out_dir, out_file, title, x_label, y_label):
